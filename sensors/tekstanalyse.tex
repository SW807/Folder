...
På Android kan man få adgang til SMS beskeder og disse kan derefter analyseres til at finde ud af en persons sindsstemning. Det kræver rettighed til applikationen til at læse SMS'er, og man skal derfor overveje brugerens privatliv. 
...
Man kan hive ud data som antal beskeder brugeren modtager, og om der er nogle specifikke keywords som kunne være interessante fra et psykiatrisk synspunkt. F.eks. kan man se om de bruger ordet "selvmord", om de bruger positivt eller negativt ladede ord, eller om der bruges korte eller lange ord. 
...
Hvis denne kan gøres præcis kunne man få en meget god indikation på en brugers sindtilstand.
