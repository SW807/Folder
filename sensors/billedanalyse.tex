...
Android kan give programmatisk adgang til kameraet. Data er et billede eller en videosekvens.
...
Vi forestiller os at vi kan lave en kort videosekvens hvor patienten bliver blitzet i perioden, for at analysere på pupillens reaktion til blitzen, se \citet{hoeks1993pupillary}.
Det kan dog være et problem hvis det skal gøres autonomt, da mange telefoner kun har blitz på bagsiden.
Konceptet illustreres i \cref{pupil}.
\begin{figure}
	\centering
...
Se \citet{kulkarni2009facial} for en beskrivelse af analysen og \cref{humor} for en illustration af konceptet.
\begin{figure}
	\centering
